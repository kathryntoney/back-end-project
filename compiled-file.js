...
var bcrypt = require('bcryptjs'); //hash and salt our password
var db = require('../models'); //models/index.js
...
router.get('/registration', /*#__PURE__*/function () {
...
router.post('/registration', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, firstName, lastName, email, password, randomString, insertRecord;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 5;
          _context2.next = 8;
          return db.owners.create({
            id: (0, _cryptoRandomString["default"])({
              length: 16
            }),
